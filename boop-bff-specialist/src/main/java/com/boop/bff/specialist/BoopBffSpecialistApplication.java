package com.boop.bff.specialist;
...
public class BoopBffSpecialistApplication {
    ...
    public WebClient webClient(ObservationRegistry observationRegistry) {
        return WebClient.builder().baseUrl("http://boop-pet-specialists")
    ...
    public static void main(String[] args)
    {
        ...
        SpringApplication.run(BoopBffSpecialistApplication.class, args);
    }
}
